...
fusionTableId:      "1mcS6k4-6uGPFYmOc2onMjXfaGnbpyTH0EX_Am38",  
googleApiKey:       "AIzaSyAuOpuElU4g8Qn5FKzfdXZfVRc2tS5QS-Q",        
/*locationColumn:     "CIUDAD",  
...
locationScope:      "lima",      //geographical area appended to all address searches
  ...
  */ 
  ...
  doSearch: function(location) {
    ...
    if (text_search != '')
    	whereClause += " AND 'PLACA' contains ignoring case '" + text_search + "'";

    var whereClause = MapsLib.locationColumn + " not equal to ''";
    
    //-----custom filters-------
var type_column = "'TYPE_MODALIDAD_SERVICIO'";
...
if ( $("#rbType4").is(':checked')) whereClause += " AND " + type_column + "=4";    
if ( $("#rbType5").is(':checked')) whereClause += " AND " + type_column + "=5";
