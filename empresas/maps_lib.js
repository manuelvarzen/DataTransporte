 ...
 *
 * Date: 12/10/2012
 * Pertenece al directori de empresas.
 */
...
var MapsLib = {
  ...
  fusionTableId:      "1vltzA9bw6zGDVvDhOCWjSvbrNekmRg2SJ_Ytb7Y",  
  ...
  map_centroid:       new google.maps.LatLng(-9.009876988275492, -73.02626837158203), //center that your map defaults to
...
whereClause += " AND " + searchType.slice(0, searchType.length - 1) + ")";
  ...
  var selectColumns = "RAZON_SOCIAL, DIRECCION, TELEFONO, MODALIDAD ";
